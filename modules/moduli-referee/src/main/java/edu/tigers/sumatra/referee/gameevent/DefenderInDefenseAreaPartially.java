...
public class DefenderInDefenseAreaPartially extends AGameEvent
{
	 ...
	 */
	public DefenderInDefenseAreaPartially(SslGcGameEvent.GameEvent event)
	{
		super(event);
	...
	public SslGcGameEvent.GameEvent toProtobuf()
	{
		...
		builder.setType(SslGcGameEvent.GameEvent.Type.DEFENDER_IN_DEFENSE_AREA_PARTIALLY);
		builder.getDefenderInDefenseAreaPartiallyBuilder()
